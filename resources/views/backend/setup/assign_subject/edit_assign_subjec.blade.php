               ...
               <form method="POST" action="{{route('update.assign.subject',$editData[0]->class_id)}}"> 
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input id="name" type="text" name="full_mark[]" value="{{$edit->full_mark}}"   class="form-control" > 
                                            </div> 
                                            {{-- @error('name')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror --}}
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input id="name" type="text"  name="pass_mark[]" value="{{$edit->pass_mark}}" class="form-control" > 
                                            </div> 
                                            {{-- @error('name')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror --}}
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input id="name" type="text" name="subjective_mark[]" value="{{$edit->subjective_mark}}"  class="form-control" > 
                                            </div> 
                                            {{-- @error('name')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror --}}
                        ...
                        <div class="text-xs-right"> 
                            <input type="submit" class="btn btn-rounded btn-info" value="Update Assign Subject">
                        </div>
               </form>
