			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Data Table : Student Exam Type Lists</h3>
                  <a href="{{route('exam.type.add')}}" style="float: right" class="btn btn-rounded btn-success mb-5">Add Exam</a>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
