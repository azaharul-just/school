...
<div class="row"> <!-- 4TH Row -->
 ...
 <div class="col-md-3">
  ...
  <div class="controls">
<input disabled type="text" name="salary" class="form-control disabled" required="" value="{{ $editData->salary }}" > 
</div>		 
</div>
...
{{--  @endif --}}
  ...
  {{-- @if (@editData) --}}
		...
		<div class="controls">
	 <input disabled type="date" name="join_date" class="form-control " required="" value="{{ $editData->join_date }}"> 
	  </div>		 
	  </div>
