                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input id="name" type="text" name="name" value="{{$editData['student']['name']}}" class="form-control" required> 
                                        </div> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input id="fname" type="text" name="fname" value="{{$editData['student']['fname']}}" class="form-control" required> 
                                        </div> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input id="mname" type="text" name="mname" value="{{$editData['student']['mname']}}" class="form-control" required> 
                                        </div> 
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input id="mobile" type="text" name="mobile" value="{{$editData['student']['mobile']}}" class="form-control" required> 
                                        </div> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input id="address" type="text" name="address" value="{{$editData['student']['address']}}" class="form-control" required> 
                                        </div> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input id="dob" type="date" name="dob" value="{{$editData['student']['dob']}}" class="form-control" required > 
                                        </div> 
